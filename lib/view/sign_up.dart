  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // Center(child: TitleMediumText(text: "registration".tr)),
          const SizedBox(
            height: 5,
          ),
          Center(
                          ...
                          Container(
                            ...
                            height:
                                step <= signUpController.currentStepIndex + 1
                                    ? 26.0
                                    : 26.0,
                            width: step <= signUpController.currentStepIndex + 1
                                ? 26.0
                                : 26.0,
                      ...
                      children: [
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            ...
                            hintText:
                                signUpController.userName ?? "userName".tr,
                          ),
                          validator: (value) {
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            ...
                            hintText:
                                signUpController.firstName ?? "firstName".tr,
                          ),
                          validator: (value) {
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            prefixIcon: const ImageIcon(
                                Svg("assets/icons/profile.svg")),
                            hintText:
                                signUpController.lastName ?? "lastName".tr,
                          ),
                          validator: (value) {
                        ...
                        GetBuilder<SignUpController>(builder: (ctx) {
                          return TextFormField(
                            decoration: InputDecoration(
                              ...
                              hintText: signUpController.birthday ??
                                  SignUpController.dateFormat
                                      .format(DateTime.now())
                                      .toString(),
                            ),
                            validator: (value) {
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: signUpController.phoneNumber ??
                                "phoneNumber".tr,
                          ),
                          maxLength: 10,
                          validator: (value) {
                        ...
                        TextButton(
                            onPressed: () {
                              if (signUpController.formKey2.currentState!
                                  .validate()) {
